"""
Runs MicroMiner on a list of input protein structures in prefilter mode.
"""
import os
...
from helper.runners import MicroMinerPrefilter
...
def main():
    ...
    if is_hpc:
        distribute_csv(dataset_file,
                       runner=MicroMinerPrefilter(cpus=1, raise_error=False),
                       outdir=outdir,
                       job_name='prefilter',
                       cpus=cpus)
    else:
        runner = MicroMinerPrefilter(cpus=cpus, raise_error=False)
